...
$form = CmsForm::getInstance()
    ...
    ->addFieldBlock('CMS',
        [
            ...
            ['name' => 'Disableable components', 'field' => CmsCheckbox::getInstance('disablable_components')->setHintText('When enabled, user can disable selected components from showing on separate page.')],
